...
veh = Bicycle(
    ...
    x0=[x0[0], x0[1], x0[2]])
veh.init(plot=True)
map = LandmarkMap(5, 50)  # no of obsticals = 25, gridsize = 50
map.plot()
...
if ((x0[0] < 40) and (x0[1] > 7.5) and (T0[0] < 40) and (T0[1] > 7.5)):
    goTo(T0[0], T0[1], veh, sensor)
...
if ((T0[0] < 40) and (T0[0] > 0) and (T0[1] < -22.5) and (T0[0] < 40) and (T0[1] > 7.5)):
    goTo(T3[0], T3[1], veh, sensor)
    goTo(T4[0], T4[1], veh, sensor)
    goTo(T0[0], T0[1], veh, sensor)

elif ((T0[0] < 40) and (T0[0] > 0) and (T0[1] < -22.5) and (T0[0] < 40) and (T0[0] > 0) and (T0[1] < -22.5)):
    goTo(T0[0], T0[1], veh, sensor)

elif ((T0[0] < 40) and (T0[0] > 0) and (T0[1] < -22.5) and (T0[1] > -22.5) and (T0[1] < 5)):
    goTo(T3[0], T3[1], veh, sensor)
    goTo(T2[0], T2[1], veh, sensor)
    goTo(T0[0], T0[1], veh, sensor)

elif ((T0[0] < 40) and (T0[0] > 0) and (T0[1] < -22.5) and (T0[0] < -10) and (T0[1] < -10)):
    goTo(T3[0], T3[1], veh, sensor)
    goTo(T2[0], T2[1], veh, sensor)
    goTo(T1[0], T1[1], veh, sensor)
    goTo(T0[0], T0[1], veh, sensor)
...
if ((T0[1] > -22.5) and (T0[1] < 5) and (T0[0] < 40) and (T0[1] > 7.5)):
    goTo(T2[0], T2[1], veh, sensor)
    goTo(T4[0], T4[1], veh, sensor)
    goTo(T0[0], T0[1], veh, sensor)

elif ((T0[1] > -22.5) and (T0[1] < 5) and (T0[0] < 40) and (T0[0] > 0) and (T0[1] < -22.5)):
    goTo(T2[0], T2[1], veh, sensor)
    goTo(T3[0], T3[1], veh, sensor)
    goTo(T0[0], T0[1], veh, sensor)

elif ((T0[1] > -22.5) and (T0[1] < 5) and (T0[1] > -22.5) and (T0[1] < 5)):
    goTo(T0[0], T0[1], veh, sensor)

elif ((T0[1] > -22.5) and (T0[1] < 5) and (T0[0] < -10) and (T0[1] < -10)):
    goTo(T1[0], T1[1], veh, sensor)
    goTo(T0[0], T0[1], veh, sensor)
